...
public class TestYilgarnLocSpecimenRecords {
    ...
    @Test
    public void testParseRecordsTest() throws Exception{
    ...
    /**
    @Test
    public void testParseInvalidRecords() throws Exception{
        final String xmlString = org.auscope.portal.Util.loadXML("src/test/resources/YilgarnLocSpecimenInvalidResponse.xml");
