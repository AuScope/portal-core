...
public class TestCSWMethodMakerGetDataRecords extends PortalTestClass {
    ...
    public void testMakeMethodFilter() throws IOException, ParserConfigurationException, SAXException {
        ...
        HttpRequestBase method = methodMaker.makeMethod(uri, mockFilter, ResultType.Results, maxRecords, CSWServiceItem.ServerType.DEFAULT);
    ...
    public void testMakeMethodNoFilter() throws IOException, ParserConfigurationException, SAXException {
        ...
        HttpRequestBase method = methodMaker.makeMethod(uri, null, ResultType.Hits, maxRecords, CSWServiceItem.ServerType.DEFAULT);
        Assert.assertNotNull(method);
    ...
    public void testKeyParameters() throws  IOException, URISyntaxException {
        ...
        //Test GET
        method = methodMaker.makeGetMethod(uri, ResultType.Results, maxRecords, 0, CSWServiceItem.ServerType.DEFAULT);
        Assert.assertNotNull(method);
