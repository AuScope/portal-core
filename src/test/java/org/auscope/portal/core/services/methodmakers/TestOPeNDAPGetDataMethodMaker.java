...
public class TestOPeNDAPGetDataMethodMaker extends PortalTestClass {
    ...
    public void testSingleAxisConstraint() throws Exception {
        ...
        context.checking(new Expectations() {{
            ...
            allowing(mockNetCdfDataset).findVariable("/" + a2.getName());will(returnValue(mockVariable1));
        }});
        ...
        context.checking(new Expectations() {{
            ...
            allowing(mockNetCdfDataset).findVariable("/" + a3.getName());will(returnValue(mockVariable1));
        }});
