...
public class TestJobStatusMonitor extends PortalTestClass {
    ...
    public void testExecuteInternal() throws Exception {
        ...
        context.checking(new Expectations() {{
            ...
            oneOf(mockJobStatusReader).getJobStatus(job1);will(returnValue(job1NewStat));
            oneOf(mockJobStatusReader).getJobStatus(job2);will(returnValue(job2NewStat));
    ...
    public void testExecuteInternal_Exception() throws Exception {
        ...
        context.checking(new Expectations() {{
            ...
            oneOf(mockJobStatusReader).getJobStatus(job1);will(throwException(new Exception()));
            oneOf(mockJobStatusReader).getJobStatus(job2);will(returnValue(job2NewStat));
