...
//                    id : 'hh-searchfield-' + childConfig.title.replace(' ',''),
//                    width : 200,
//                    fieldName: 'name',
//                    store : childConfig.store
//                },{
//                    xtype : 'button',
//                    id : 'hh-filterDisplayedLayer-' + childConfig.title.replace(' ',''),
//                    text : 'View by',
//                    iconCls : 'filter',
...
//                      newLayer = childConfig.layerFactory.generateLayerFromCSWRecord(record);                                                     
//                  }else{
//                      newLayer = childConfig.layerFactory.generateLayerFromKnownLayer(record);                      
//                  }           
//                  record.set('layer',newLayer);
//                  var filterForm = childConfig.layerFactory.formFactory.getFilterForm(newLayer).form; //ALWAYS recreate filter form - see https://jira.csiro.au/browse/AUS-2588
...
//        });
     ...
     * Override to provide own definition
     */
...
//    },
    ...
    // Copied from BaseActiveRecordPanel
