...
<xsl:stylesheet version="2.0"
   ...
   -->
   <xsl:template name="start-table"><![CDATA[<div style='min-width: 400px; max-width:650px; min-height: 100px; max-height: 350px; overflow: auto;"'><table border="1" cellpadding="4" class="auscopedefault" style="font-family: Verdana;
        font-weight: normal;
        font-size: 12px;
        color: #404040;
