...
/**
 * General exception thrown when there is an error checking/updating job status. This class can be used
 * as a general purpose exception or as a collection of exceptions for a batch status update
 * 
 * @author Josh Vote
 *
 */
