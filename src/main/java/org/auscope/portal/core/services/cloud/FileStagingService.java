...
public class FileStagingService {
     ...
     * @return
     */
    private File getFile(VmJob job, String fileName) {
     ...
     * @return
     */
    public static String getBaseFolderForJob(VmJob job) {
     ...
     */
    public boolean deleteStageInDirectory(VmJob job) {
     ...
     * @return
     */
    public boolean deleteStageInFile(VmJob job, String fileName) {
     ...
     * @return
     */
    public boolean renameStageInFile(VmJob job, String currentFileName, String newFileName) {
     ...
     * @return
     */
    public boolean stageInFileExists(VmJob job, String fileName) {
     ...
     */
    public boolean stageInDirectoryExists(VmJob job) throws PortalServiceException {
     ...
     * @throws IOException If the directory creation fails
     */
    public void generateStageInDirectory(VmJob job) throws PortalServiceException {
        String jobInputDir = pathConcat(stagingInformation.getStageInDirectory(), getBaseFolderForJob(job));
     ...
     * @throws IOException
     */
    public StagedFile[] listStageInDirectoryFiles(VmJob job) throws PortalServiceException {
     ...
     */
    public InputStream readFile(VmJob job, String fileName) throws PortalServiceException {
        try {
     ...
     * @return
     */
    public OutputStream writeFile(VmJob job, String fileName) throws PortalServiceException{
     ...
     * @return
     */
    public OutputStream writeFile(VmJob job, String fileName, boolean append) throws PortalServiceException {
        File f = getFile(job, fileName);
        try {
	 ...
	 * @throws PortalServiceException
	 */
	private StagedFile fileUploadHelper(VmJob job, MultipartFile f)
			throws PortalServiceException {
     ...
     * @throws PortalServiceException
     */
    public StagedFile handleFileUpload(VmJob job, MultipartHttpServletRequest request) throws PortalServiceException {
     ...
     * @throws IOException
     */
    public List<StagedFile> handleMultiFileUpload(VmJob job, MultipartHttpServletRequest request) throws PortalServiceException {
     ...
     * @throws IOException
     */
    public void handleFileDownload(VmJob job, String fileName, HttpServletResponse response) throws PortalServiceException {
        String directory = pathConcat(stagingInformation.getStageInDirectory(), getBaseFolderForJob(job));
