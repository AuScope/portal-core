...
public class YilgarnLocSpecimenController {
    ...
    public void downloadLocSpecAsZip( @RequestParam("serviceUrls") final String serviceUrls,
        ...
        response.setHeader("Content-Disposition","inline; filename=LocSpec.zip;");
        ...
        ZipOutputStream zout = new ZipOutputStream(response.getOutputStream());
            ...
            GetMethod method = new GetMethod(serviceUrls);
            HttpClient client = serviceCaller.getHttpClient();

            logger.trace("Calling service: " + serviceUrls);
            ...
            Object dataObject = jsonObject.get("gmlResponse");
            Object messageObject = jsonObject.get("errorMsg"); //This will be used as an error string
            if (messageObject == null) {
            	messageObject = ""; 
            }
            
        	if (dataObject != null) {
        		gmlBytes = dataObject.toString().getBytes();
        	}
            ...
            if(jsonObject.get("success").toString().equals("false")) {
            	...
            	zout.putNextEntry(new ZipEntry(new SimpleDateFormat("yyyyMMdd_HHmmss").format(new Date()) + "-" + messageString + ".xml"));
            } else {
