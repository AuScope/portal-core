...
public class AdminDiagnosticResponse implements Serializable {
     ...
     * @param details Any useful pieces of info relating to the operation
     * @param warnings Any (non critical) problems that occurred during the operation
     * @param errors Any critical problems that occurred during the operation
     */
     ...
     * @param detail useful pieces of info relating to this operation
     */
     ...
     * @param warning a (non critical) problem that occurred during the operation
     */
     ...
     * @param error a error that occurred during the operation
     */
